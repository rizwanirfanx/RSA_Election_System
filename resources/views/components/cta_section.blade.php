<section class="bg-white dark:bg-gray-900">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div class="mt-4 md:mt-0">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Let's
                Embrace Better Electoral Process</h2>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                "Embrace the future of democracy with the E-Election System for Pakistan! Join us in revolutionizing the
                way we vote by adopting a secure, transparent, and accessible electronic voting platform. Let's empower
