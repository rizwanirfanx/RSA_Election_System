                        ...
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="/voter-verification"
                                    class="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:lg:">Vote</a>
                            </li>
                            <li>
                                <a href="/about-us"
    ...
    <footer class="p-4 sm:p-6 mt-6 bg-green-800">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center ">© 2023 <a href="/"
                    class="hover:underline text-white">RSA™</a>.
                All Rights Reserved.
            </span>
